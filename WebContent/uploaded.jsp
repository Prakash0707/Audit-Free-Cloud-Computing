    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="homepage.jsp">upload here</a></li>
          <li><a href="decrypt.jsp">Decrypt</a></li>
<!--           <li><a href="contact.html">Contact Us</a></li> -->
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <form action="fileupload" method="post" name="myForm" enctype="multipart/form-data">
<%-- 		<h1><% out.println("welcome");%></h1> --%>
		
	<h1>	<%=request.getSession().getAttribute("uname")%></h1>
			<h1>your file was successfully uploaded and you will get the encrypted message in registerd directory </h1>
			<table>
