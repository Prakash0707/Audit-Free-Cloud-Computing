...
<!--         <p><a href="#"><img src="images/readmore.gif" width="113" height="37" alt="" border="0" /></a></p> -->
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <form action="fileupload" method="post" name="myForm" enctype="multipart/form-data" name="myForm">
	...
	<tr><td></td><td><input type="submit" value="UPLOAD HERE" onclick="return validateForm()" /></td></tr>
			</table>	
